...
const dictionaries={
  en:{
    ...
    "share.title":"The Royal Chamber",
    "share.text":"Try this puzzle seed.",
    "share.copied":"Link copied.",
    "share.cancelled":"Share was cancelled."
  },
  es:{
    "app.title":"La Sala Real",
    "moves.label":"Movs.",
    "menu.open":"Abrir menú",
    "menu.title":"Menú",
    "target.card":"Objetivo {n}",
    "target.board":"Tablero objetivo",
    "target.controls":"Controles del objetivo",
    "target.rotateLeft":"Girar el objetivo en sentido antihorario, suma un movimiento",
    "target.rotateRight":"Girar el objetivo en sentido horario, suma un movimiento",
    "target.flipH":"Reflejar el objetivo horizontalmente, suma un movimiento",
    "target.flipV":"Reflejar el objetivo verticalmente, suma un movimiento",
    "board.playable":"Tablero de juego",
    "board.aria":"Tablero de ajedrez jugable",
    "controls.aria":"Controles del juego",
    "actions.reset":"Estado inicial",
    "actions.undo":"Deshacer",
    "actions.retry":"Reintentar",
    "actions.nextCard":"Siguiente Objetivo",
    ...
    "instructions.goalText":"Mueve las piezas hasta que el tablero de juego coincida exactamente con el Objetivo.",
    "instructions.turnsTitle":"Turnos",
    "instructions.turnsText":"Toca una pieza para ver sus movimientos legales, luego toca una casilla resaltada para mover. Las piezas nunca capturan.",
    "instructions.toolsText":"Puedes rotar o reflejar el Objetivo, pero cada cambio suma un movimiento.",
    "instructions.chainTitle":"Encadenando Objetivos",
    "instructions.chainText":"Después de resolver un Objetivo, obtendrás calificación (intenta hacerlo perfecto!). Puedes reintentar el Objetivo o tomar uno nuevo y continuar desde tu tablero resuelto.",
    "instructions.piecesAria":"Reglas de movimiento de las piezas",
    "instructions.king":"Se mueve una casilla en cualquier dirección.",
    "instructions.queen":"Se desliza horizontal, vertical o diagonalmente cualquier número de casillas libres.",
    "instructions.rook":"Se desliza horizontal o verticalmente cualquier número de casillas libres.",
    "instructions.bishop":"Se mueve en diagonal cualquier número de casillas oscuras libres.",
...
function resultMessage(){
  ...
  if(moves===boardPar) return t("rating.good");
